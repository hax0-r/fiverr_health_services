...
$toemails[] = array(
	'email' => 'cloudkew265@gmail.com', // Your Email Address
	'name' => 'JTNH Healthservices' // Your Name
);
...
$fromemail = array(
	'email' => 'no-reply@jtnhealthservices.com', // Company's Email Address (preferably currently used Domain Name)
	'name' => 'JTN Healthservices' // Company Name
);
...
$mail->SMTPSecure = "ssl";
$mail->Port = 465;
$mail->Username = "brad@smtp.jtnhealthservices.com";
$mail->Password = "57bf64cd14e014d13908cb5c6b73c826-667818f5-180b5348";
...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
	...
	$ar_footer	= !empty( $submits['ar_footer'] ) ? $submits['ar_footer'] : 'Copyrights &copy; ' . date('Y') . ' <strong>Cloudkew</strong>. All Rights Reserved.';
